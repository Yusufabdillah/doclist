                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <i class="la la-list-ol"></i> Tabel Data Keyword
                            </h3>
                        </div>
                    </div>
                    <?php
                    if ($get_keyword !== '401') {
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <li class="m-portlet__nav-item">
                                    <a href="<?= site_url('b_keyword/form'); ?>" class="btn m-btn--pill btn-accent"
                                       data-container="body"
                                       data-toggle="m-popover"
                                       data-placement="left"
                                       data-skin="dark"
                                       data-html="true"
                                       data-content="<i class='la la-info-circle'></i> Tambah Keyword"
                                    >
...
<?php
$this->load->view('backend/keyword/modalDelete');
$this->load->view('backend/keyword/JSDatatable');
$this->load->view('backend/keyword/JSNotify');
$this->load->view('backend/keyword/JS');
