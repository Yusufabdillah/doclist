...
<div class="widget animation-fadeInLeft">
	<div class="widget-extra themed-background-warning">
		<h3 class="widget-content-light">
			Dokumen Termutasi <i class="fa fa-long-arrow-right"></i> <i class="fa fa-question-circle-o"></i> Belum Diverifikasi
		</h3>
	</div>
...
<?php
$this->load->view('frontend/mutasi/ajax_view/termutasi_false/JS_DT_Index');
